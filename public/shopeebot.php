 ...
 *
 * REGISTER in Shopee Open Platform as Redirect URL, e.g.:
 *   https://cdn.corenationactive.com/shopeebot.php
 *
 * This file contains NO secrets. It forwards the browser to the Laravel app,
 * which exchanges `code` + `shop_id` for access/refresh tokens.
 *
 * Deploy on CDN (cdn.*) or the main app domain. Set LARAVEL_OAUTH_CALLBACK below
 * or server env SHOPEE_OAUTH_CALLBACK_URL to your Laravel callback route.
 */
