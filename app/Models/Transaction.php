...
class Transaction extends Model
{
    ...
    {
        return match ($this->submit_type) { self::SUBMIT_TYPE_MANUAL => 'Manual', self::SUBMIT_TYPE_JUBELIO => 'Jubelio Sync', default => 'Unknown' };
    }

    public function isManual(): bool { return $this->submit_type === self::SUBMIT_TYPE_MANUAL; }
    public function isFromJubelio(): bool { return $this->submit_type === self::SUBMIT_TYPE_JUBELIO; }

    public function sender() { return $this->belongsTo(Addrbook::class, 'sender_id'); }
    public function receiver() { return $this->belongsTo(Addrbook::class, 'receiver_id'); }
    public function details() { return $this->hasMany(TransactionDetail::class); }
    public function user() { return $this->belongsTo(User::class); }
    public function submitByA() { return $this->belongsTo(User::class, 'a_submit_by'); }
    public function submitByB() { return $this->belongsTo(User::class, 'b_submit_by'); }
