...
CREATE TABLE `items` (
  ...
  `legacy_code` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE `restock_sheets` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `type_tag_id` bigint(20) UNSIGNED NOT NULL,
  `representative_group_id` bigint(20) UNSIGNED DEFAULT NULL,
  `created_by` bigint(20) UNSIGNED NOT NULL,
  `last_saved_at` timestamp NULL DEFAULT NULL,
  `last_saved_by` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `restock_cell_histories`
  ...
  ADD KEY `restock_cell_histories_transaction_id_foreign` (`transaction_id`),
...
ALTER TABLE `restock_cell_histories`
  ...
  ADD CONSTRAINT `restock_cell_histories_transaction_id_foreign` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE SET NULL,
...
ALTER TABLE `restock_sheets`
  ...
  ADD CONSTRAINT `restock_sheets_representative_group_id_foreign` FOREIGN KEY (`representative_group_id`) REFERENCES `item_groups` (`id`) ON DELETE SET NULL,
