                            ...
                            data.map((item, index) => (
                                ...
                                >
                                    ...
                                    <TableCell className="text-right font-medium text-emerald-600 dark:text-emerald-400">
                                        {formatCurrency(item.cash_in_total)}
                                    </TableCell>
                                    <TableCell className="text-right font-medium text-rose-600 dark:text-rose-400">
                                        {formatCurrency(item.cash_out_total)}
                                    </TableCell>
                                    <TableCell className="text-right font-medium">
                                        {formatCurrency(item.sell_total)}
                                    </TableCell>
                                    <TableCell className="text-right font-medium text-rose-500">
                                        {formatCurrency(item.return_total)}
                                    </TableCell>
                                    <TableCell className="text-right font-medium">
                                        {formatCurrency(item.buy_total)}
                                    </TableCell>
                                    <TableCell className="text-right font-medium text-emerald-500">
                                        {formatCurrency(item.return_suplier)}
                                    </TableCell>
                                </TableRow>
                            ))
                        )}
