...
import { FilePen, Trash2, Plus, Search, Book, Eye, ArrowLeft } from 'lucide-react';
...
export default function OperationShow({ operation, accounts }: Props) {
    ...
    const handleSearch = (e: React.FormEvent) => {
        e.preventDefault();
        router.get(`/journals/operations/${operation.id}`, { search }, { preserveState: true });
    };
            ...
            <div className="p-4 sm:p-6 lg:p-8">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">Operation: {operation.name}</h2>
                            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Account list bound to this operation.</p>
                        </div>
                    </div>
                                ...
                                {accounts.data.length === 0 && (
                                    <tr>
                                        <td colSpan={2} className="px-6 py-12 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                            No accounts found in this operation yet.
                                        </td>
                                    </tr>
                                )}
                            </tbody>
