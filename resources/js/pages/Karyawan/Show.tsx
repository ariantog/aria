...
export default function Show({ karyawan, auth }: any) {
    ...
    const getTipeCuti = (tipe: number) => {
        switch (tipe) {
            case 1:
                return <span className="text-blue-600">Tahunan</span>;
            case 2:
                return <span className="text-orange-600">Sakit</span>;
            case 3:
                return <span className="text-red-600">Mendadak/Izin</span>;
            default:
                return 'Lainnya';
        }
    };
                            ...
                            <div className="space-y-2 border-t pt-4">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">
                                        {formatCurrency(karyawan.bulanan)}
                                    </span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-sm text-muted-foreground">
                                    ...
                                    <span className="font-medium">
                                        {formatCurrency(karyawan.harian)}
                                    </span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-sm text-muted-foreground">
                                                    ...
                                                    (cuti: any) => (
                                                        ...
                                                        >
                                                            <td className="p-4 align-middle">
                                                                ...
                                                                {cuti.tgl_mulai !==
                                                                    cuti.tgl_akhir &&
                                                                    ` - ${format(new Date(cuti.tgl_akhir), 'dd MMM yyyy', { locale: id })}`}
                                                            </td>
                                                            <td className="p-4 align-middle font-medium">
                                                                {getTipeCuti(
                                                                    cuti.tipe,
