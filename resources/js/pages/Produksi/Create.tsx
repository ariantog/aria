    ...
    const handleKeyDown = (
        ...
        if (e.key === 'Enter') {
            ...
            if (form) {
                ...
                if (
                    indexInFocusables > -1 &&
                    indexInFocusables < focusables.length - 1
                ) {
                    ...
                    <div className="mb-8 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-zinc-500 dark:text-zinc-400">
                                Record a new batch of production at the Potong
                                stage.
                            </p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={data.potong_id}
                                        onValueChange={(val) =>
                                            setData('potong_id', val)
                                        }
                                    >
                                        <SelectTrigger
                                            id="worker"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="sj_potong">
                                        Surat Jalan Potong
                                    </Label>
                                    <div className="relative">
                                        <Hash className="absolute top-2.5 left-3 h-4 w-4 text-zinc-400" />
                                        <Input
                                            id="sj_potong"
                                            className="pl-9"
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-zinc-200 dark:divide-zinc-800">
                                    <thead className="bg-zinc-50/50 dark:bg-zinc-900/50">
                                        <tr>
                                            <th className="px-4 py-3 text-left text-xs font-semibold tracking-wider text-zinc-500 uppercase">
                                                Product Name
                                            </th>
                                            <th className="w-32 px-4 py-3 text-left text-xs font-semibold tracking-wider text-zinc-500 uppercase">
                                                Size
                                            </th>
                                            <th className="w-24 px-4 py-3 text-left text-xs font-semibold tracking-wider text-zinc-500 uppercase">
                                                Qty
                                            </th>
                                            <th className="px-4 py-3 text-left text-xs font-semibold tracking-wider text-zinc-500 uppercase">
                                                Customer
                                            ...
                                            <th className="w-16 px-4 py-3 text-center text-xs font-semibold tracking-wider text-zinc-500 uppercase"></th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-zinc-200 bg-white dark:divide-zinc-800 dark:bg-zinc-900">
                                        {data.items.map((item, index) => (
                                            <tr
                                                key={index}
                                                className="group hover:bg-zinc-50/30 dark:hover:bg-zinc-800/30"
                                            >
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="relative">
                                                        <UserCircle className="absolute top-2.5 left-2.5 h-3.5 w-3.5 text-zinc-400" />
                                                        <Input
                                                            className="pl-8"
                                                            value={
                                                                item.customer ||
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="relative">
                                                        <Palette className="absolute top-2.5 left-2.5 h-3.5 w-3.5 text-zinc-400" />
                                                        <Input
                                                            className="pl-8"
                                                            value={
                                                                item.warna || ''
                        ...
                        <div className="flex items-center justify-end gap-4">
                            ...
                            <Button
                                type="submit"
                                disabled={processing}
                                className="min-w-[150px] gap-2 bg-blue-600 text-white hover:bg-blue-700"
                            >
