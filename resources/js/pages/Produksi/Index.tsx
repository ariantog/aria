...
export default function ProduksiIndex({ produksis, jahitList, filters, can }: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4 ">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                    <div>
                        <h2 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">Produksi</h2>
                                    ...
                                    <tr key={p.id} className="group hover:bg-zinc-50/50 dark:hover:bg-zinc-800/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-center">
                                            <div className="flex items-center justify-center gap-1.5">
                                                ...
                                                {can.setor_produksi && p.jahit_date && (
                                                    <Button
                                                        size="icon"
                                                        variant="destructive"
