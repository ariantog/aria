...
export default function AddrbookCreate({ types, preselected_type_id, ppn_rate }: Props) {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Card className="border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50">
                            <CardHeader>
                                ...
                                <CardDescription>Initial setup for accounting.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <FormInput
                                    id="initial_balance"
                                ...
                                <p className="text-xs text-zinc-500">
                                    Set the starting balance. Positive = Receivable, Negative = Payable (if applicable).
                                </p>
                            </CardContent>
                        </Card>
                    </div>
