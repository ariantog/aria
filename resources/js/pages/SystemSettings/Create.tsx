            ...
            <div className="p-4 sm:p-6 lg:p-8">
                <div className="max-w-3xl mx-auto">
                    <div className="mb-8 flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50 mb-1">Create Setting</h1>
                            <p className="text-zinc-500 dark:text-zinc-400">Add a new configuration parameter to the system.</p>
                        </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <Card className="border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <FormInput
                                    ...
                                    required
                                />
                                <p className="text-xs text-zinc-500 mt-[-12px]">Lowercase letters, numbers, and underscores only.</p>
                        ...
                        <div className="flex justify-end gap-3">
                            ...
                            <Button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white" disabled={processing}>
                                <Save className="mr-2 h-4 w-4" /> {processing ? 'Creating...' : 'Create Setting'}
                            </Button>
                        </div>
                    </form>
                </div>
