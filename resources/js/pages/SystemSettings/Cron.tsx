            ...
            <div className="p-4 sm:p-6 lg:p-8">
                <div className="space-y-6">
                    ...
                    <Card className="overflow-hidden rounded-2xl border-zinc-200 shadow-sm dark:border-zinc-800">
                        <CardHeader className="border-b border-zinc-100 bg-zinc-50/50 p-6 dark:border-zinc-800 dark:bg-zinc-900/50">
                        ...
                        <CardContent className="p-0">
                            <div className="overflow-x-auto">
                                <Table>
                                    <TableHeader className="border-b border-zinc-100 bg-zinc-50 text-xs text-zinc-500 uppercase dark:border-zinc-800 dark:bg-zinc-950/50">
                                        <TableRow>
                                            <TableHead className="px-6 py-4 font-bold tracking-wider">
                                                Name
                                            </TableHead>
                                            <TableHead className="px-6 py-4 font-bold tracking-wider">
                                                Frequency
                                            </TableHead>
                                            <TableHead className="px-6 py-4 text-center font-bold tracking-wider">
                                                Status
                                            </TableHead>
                                            <TableHead className="px-6 py-4 font-bold tracking-wider">
                                                Last Run
                                            </TableHead>
                                            <TableHead className="px-6 py-4 text-right font-bold tracking-wider">
                                                Actions
                                            </TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody className="divide-y divide-zinc-100 dark:divide-zinc-800/50">
                                        {tasks.map((task) => (
                                            ...
                                            >
                                                ...
                                                <TableCell className="px-6 py-4">
                                                    <span className="inline-flex items-center rounded-full border border-blue-100 bg-blue-50 px-2.5 py-0.5 text-xs font-medium text-blue-700 dark:border-blue-800 dark:bg-blue-900/20 dark:text-blue-300">
                                                        {getFrequencyLabel(
                                                            task.frequency,
                                                        )}
                                                    </span>
                ...
                >
                    <DialogContent className="rounded-2xl sm:max-w-[425px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Update the name and execution schedule for this
                                task.
                            </DialogDescription>
                        </DialogHeader>
                        <form onSubmit={submit} className="space-y-4 pt-4">
                            ...
                            <DialogFooter className="pt-4">
                                ...
                                <Button
                                    type="submit"
                                    disabled={processing}
                                    className="rounded-xl bg-blue-600 text-white shadow-lg shadow-blue-500/20 hover:bg-blue-700"
                                >
                                    Save Changes
                                </Button>
                            </DialogFooter>
