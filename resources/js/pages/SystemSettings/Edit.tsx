            ...
            <div className="p-4 sm:p-6 lg:p-8">
                <div className="max-w-3xl mx-auto">
                    <div className="mb-8 flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50 mb-1">Edit Setting</h1>
                            <p className="text-zinc-500 dark:text-zinc-400">Modify the configuration parameter.</p>
                        </div>
                        ...
                        <Card className="border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50">
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-2 opacity-60">
                                    <Label className="text-zinc-700 dark:text-zinc-300 font-medium">Slug (System Key)</Label>
                                    <div className="p-2 border border-zinc-200 dark:border-zinc-800 rounded bg-zinc-50 dark:bg-zinc-950 font-mono text-sm">
                                        {setting.slug}
                                    </div>
                                </div>
