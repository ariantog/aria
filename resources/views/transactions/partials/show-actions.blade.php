<div class="flex flex-wrap items-center gap-2">
    ...
    <button type="button" @click="waOpen = true"
            class="inline-flex items-center gap-1.5 rounded-md border border-green-300 bg-green-50 px-3 py-2 text-sm font-medium text-green-700 hover:bg-green-100">
    ...
    <div class="relative" x-data="{ open: false }">
        <button type="button" @click="open = !open"
                class="inline-flex h-9 w-9 items-center justify-center rounded-md border border-gray-300 bg-white text-gray-500 hover:bg-gray-50 hover:text-gray-700"
                title="More actions">
        ...
        <div x-show="open" x-cloak @click.away="open = false"
            ...
            <form method="POST" action="{{ route('transactions.draft-return', $transaction->id) }}">
                @csrf
                <button type="submit" data-testid="draft-return-button"
                        class="flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-orange-700 hover:bg-orange-50">
            ...
            @endif
            <button type="button" @click="open = false; deleteConfirmOpen = true"
