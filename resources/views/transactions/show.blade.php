...
<div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4"
     x-data="{ showImage: true, showBarcode: true, showSku: false, waOpen: false,
        get nameColSpan() {
        ...
        <div class="flex flex-wrap items-center gap-2">
            <a href="{{ route('transactions.receipt', $transaction->id) }}" target="_blank"
               class="inline-flex items-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                Print POS
            </a>
            ...
            <form method="POST" action="{{ route('transactions.pdf.store', $transaction->id) }}" class="inline">
                @csrf
                <button type="submit" data-testid="regenerate-pdf-button"
                        class="inline-flex items-center gap-2 rounded-md border border-blue-300 bg-white px-4 py-2 text-sm font-medium text-blue-700 hover:bg-blue-50">
            ...
            <button type="button" @click="waOpen = true"
                    class="inline-flex items-center gap-2 rounded-md border border-green-300 bg-green-50 px-4 py-2 text-sm font-medium text-green-700 hover:bg-green-100">
