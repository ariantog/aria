...
$breadcrumbs = [
    ...
    ['title' => 'Edit Location', 'href' => route('locations.edit', $location->id)],
];
@endphp

<div class="flex flex-col gap-4 p-3 sm:p-4">
    <div>
        <h2 class="text-2xl font-bold tracking-tight text-gray-900">Edit Location</h2>
        <p class="mt-0.5 text-sm text-gray-500">Update location details.</p>
    </div>
