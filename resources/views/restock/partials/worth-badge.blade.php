...
$badgeClass = match ($pattern) {
    ...
    \App\Services\Restock\RestockSkuConfidenceService::PATTERN_FAST => 'bg-sky-100 text-sky-900 ring-sky-200',
    \App\Services\Restock\RestockSkuConfidenceService::PATTERN_MEDIUM => 'bg-violet-100 text-violet-900 ring-violet-200',
