...
<div class="flex flex-col gap-4 p-3 sm:p-4">
    <div>
        <h2 class="text-2xl font-bold tracking-tight text-gray-900">Create New Post</h2>
    </div>
    ...
    <div class="max-w-2xl overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        <form method="POST" action="{{ route('posts.store') }}" class="p-6">
            ...
            <div class="mb-6">
                ...
                <textarea name="content" rows="8" required placeholder="Write your post content here..."
                          class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500">{{ old('content') }}</textarea>
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="rounded-lg bg-blue-700 px-6 py-2 text-sm font-medium text-white hover:bg-blue-800">Create Post</button>
            </div>
        </form>
    </div>
</div>
