...
<div class="p-4">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-3xl font-extrabold tracking-tight text-zinc-900">Edit Production</h2>
    ...
    <div class="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div class="space-y-8 lg:col-span-2">
            ...
            {{-- Split Form --}}
            <div class="rounded-xl border border-l-4 border-zinc-200 border-l-orange-500 bg-white p-6 shadow-md">
                <h3 class="flex items-center gap-2 text-lg font-semibold">
                    <svg class="h-5 w-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                    Pisah Jahit (Split)
                </h3>
                <p class="mt-1 text-sm text-zinc-500">Split this record into two separate entries by specifying the split quantity.</p>
