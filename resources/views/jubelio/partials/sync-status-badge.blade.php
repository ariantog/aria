...
@if($status == 2 && $errorType == 10)
    <span class="inline-flex items-center gap-1.5 rounded-full border border-green-500/20 bg-green-50 px-2.5 py-0.5 text-[10px] font-bold text-green-600 uppercase">
...
@elseif($status == 2 && $errorType == 2)
    <span class="inline-flex items-center gap-1.5 rounded-full border border-yellow-500/20 bg-yellow-50 px-2.5 py-0.5 text-[10px] font-bold text-yellow-600 uppercase">
...
@elseif($status == 1 && $errorType == 1)
    <span class="inline-flex items-center gap-1.5 rounded-full border border-red-500/20 bg-red-50 px-2.5 py-0.5 text-[10px] font-bold text-red-600 uppercase">
...
@elseif($status == 0)
    <span class="inline-flex items-center gap-1.5 rounded-full border border-blue-500/20 bg-blue-50 px-2.5 py-0.5 text-[10px] font-bold text-blue-600 uppercase">
